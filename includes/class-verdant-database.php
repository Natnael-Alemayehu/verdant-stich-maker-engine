...
class VerdantStitch_Database {
    ...
    public function __construct() {
        ...
        $this->images   = $wpdb->prefix . 'verdant_milestone_images';
        $this->mastery  = $wpdb->prefix . 'verdant_mastery_scores';
    }
    ...
    /**
     * Fetch all kit rows for a given user.
     *
     * @param int $user_id
     * @return array<object>
     */
    ...
    /**
     * Update a kit row (ownership-enforced).
     *
     * @param int   $kit_row_id
     * @param int   $user_id
     * @param array $data
