...
class VerdantStitch_Activator {
    ...
    private static function create_tables(): void {
        ...
        $sql_kits   = "CREATE TABLE {$table_kits} (
            ...
            difficulty      TINYINT(1) UNSIGNED NOT NULL DEFAULT 1 COMMENT '1=Beginner, 2=Intermediate, 3=Advanced, 4=Master',
        ...
        // Table 2 – Progress history (timestamped log).
