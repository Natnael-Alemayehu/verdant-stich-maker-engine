 ...
 *   – API Tester (interactive GET / POST demo within the admin)
 *   – Settings
 *
...
class VerdantStitch_Admin {
    ...
    public function enqueue_assets( string $hook ): void {
        ...
        wp_enqueue_script(
            'verdant-api-tester',
            VERDANT_PLUGIN_URL . 'assets/js/api-tester.js',
            [ 'wp-api', 'jquery' ],
            VERDANT_VERSION,
            true
        );
    ...
    public function register_settings(): void {
        ...
        add_settings_field( 'verdant_coupon_expiry_days', __( 'Coupon Expiry (days)', 'verdant-stitch' ),
            function() {
